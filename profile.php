...
<head>
	<title>Profile Viewer | wfdata.io</title>
...
<body data-bs-theme="dark">
	...
	<script>
		...
		{
			initialDataUrl = "https://api.builds.wf/profile?account=" + encodeURIComponent(params.get("account"));
		...
		function doLookup()
		{
			...
			fetch("https://api.builds.wf/profile?account=" + encodeURIComponent(document.getElementById("username").value) + "&platform=" + document.getElementById("platform").value).then(res => res.json()).then(data =>
			{
				if (data)
				{
					window.profile = data;
